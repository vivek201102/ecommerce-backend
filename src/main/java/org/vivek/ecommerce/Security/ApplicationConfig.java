...
public class ApplicationConfig {
    ...
    public AuthenticationProvider authenticationProvider(){
        DaoAuthenticationProvider auhProvider = new DaoAuthenticationProvider();
        auhProvider.setUserDetailsService(userDetailsService());
        auhProvider.setPasswordEncoder(passwordEncoder());
        return auhProvider;
    }
